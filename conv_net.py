...
class conv_net:
    ...
    def train(self, input, answer, epochs, validation_split=0.25):
        self.history = self.neural_network_layer.fit(input, answer, epochs=epochs, validation_split=validation_split)
